...
#define SOURCE_SHADER_FILE_CS (L"CalcShader.hlsl")
...
namespace Mawi1e {
	...
	private:
		...
		void DoComputeWork();
		void BuildRootSigCalc();

	private:
		std::unique_ptr<TestSimulation> m_TestSimulation;
		...
		Microsoft::WRL::ComPtr<ID3D12RootSignature> m_RootSignature, m_CalcRootSignature;
		...
		[                                        VecAdd                                       ]
		----------------------------------------------------------------------------------- **/
		Microsoft::WRL::ComPtr<ID3D12Resource> m_InputA_GPU, m_InputA_Uploader;
		Microsoft::WRL::ComPtr<ID3D12Resource> m_InputB_GPU, m_InputB_Uploader;

		Microsoft::WRL::ComPtr<ID3D12Resource> m_OutputBuffer, m_ReadBackBuffer;
		size_t m_NumBufferElementCount = 30;
