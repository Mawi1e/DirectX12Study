...
#define SOURCE_SHADER_FILE_TESS_VS (L"TesselationShader.hlsl")
#define SOURCE_SHADER_FILE_TESS_HS (L"TesselationShader.hlsl")
#define SOURCE_SHADER_FILE_TESS_DS (L"TesselationShader.hlsl")
#define SOURCE_SHADER_FILE_TESS_PS (L"TesselationShader.hlsl")
...
namespace Mawi1e {
	...
	private:
		...
		void BuildQuadPathGridGeometry();
	...
	private:
		...
		std::vector<D3D12_INPUT_ELEMENT_DESC> m_TesselationInputElement;
