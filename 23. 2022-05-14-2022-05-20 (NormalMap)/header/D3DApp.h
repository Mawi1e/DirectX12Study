...
#define SOURCE_SHADER_FILE_VS (L"Shader_005.hlsl")
#define SOURCE_SHADER_FILE_PS (L"Shader_005.hlsl")

#define SOURCE_SHADER_FILE_CUBEMAP_VS (L"CubeMap.hlsl")
#define SOURCE_SHADER_FILE_CUBEMAP_PS (L"CubeMap.hlsl")
