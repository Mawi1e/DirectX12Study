...
namespace Mawi1e {
	struct ObjConstants {
		...
		DirectX::XMFLOAT4X4 WorldInvTranspose = VertexBuffer::GetMatrixIdentity4x4();
	};
	...
	class FrameResource {
	public:
		FrameResource(ID3D12Device*, UINT, UINT, UINT, UINT);
		...
		std::unique_ptr<UploadBuffer<Vertex>> m_WaveVB = nullptr;
